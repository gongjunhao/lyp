...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="${pageContext.request.contextPath}/static/lyp/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/static/lyp/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="${pageContext.request.contextPath}/static/morrisjs/morris.css" rel="stylesheet">
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/">乐品科技</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="${pageContext.request.contextPath}/static/lyp/pages/login.html"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/"><i class="fa fa-dashboard fa-fw"></i>控制面板</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/flot.html">Flot Charts</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/morris.html">Morris.js Charts</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/static/lyp/pages/tables.html"><i class="fa fa-table fa-fw"></i> Tables</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/static/lyp/pages/forms.html"><i class="fa fa-edit fa-fw"></i> Forms</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i> UI Elements<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/panels-wells.html">Panels and Wells</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/buttons.html">Buttons</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/typography.html">Typography</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/icons.html"> Icons</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/static/lyp/pages/grid.html">Grid</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
<script src="${pageContext.request.contextPath}/static/raphael/raphael-min.js"></script>
<script src="${pageContext.request.contextPath}/static/morrisjs/morris.min.js"></script>
<script src="${pageContext.request.contextPath}/static/lyp/js/morris-data.js"></script>
